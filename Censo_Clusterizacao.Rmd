...
df_clusters_k6_sumarioPLOT <-
  as.data.frame(t(df_clusters_k6_sumario)) %>%
  rename("CL 1" = V1,
         "CL 2" = V2,
         "CL 3" = V3,
         "CL 4" = V4,
...
df_clusters_k6_sumarioPLOT[8,1] <- "Rendimentos totais da AF"
df_clusters_k6_sumarioPLOT[9,1] <- "Rendimentos totais da AP"
df_clusters_k6_sumarioPLOT[10,1] <- "Nº de microrregiões"
...
our_summary1 <-
  list("Proporção de área AF" =
       list("min"       = ~ round(min(AF_prop_AREA), 2),
            "Mediana"    = ~ round(median(AF_prop_AREA), 2),
            "max"       = ~ round(max(AF_prop_AREA), 2),
            "Média"      = ~ round(mean(AF_prop_AREA), 2)),
       
       "Proporção de ocupados na AF" =
       list("min"       = ~ round(min(AF_prop_OCU), 2),
            "Mediana"    = ~ round(median(AF_prop_OCU), 2),
            "max"       = ~ round(max(AF_prop_OCU), 2),
            "Média"      = ~ round(mean(AF_prop_OCU), 2)),
       "Ocupados por ha útil da AF" =
       list("min"       = ~ round(min(AF_prop_OCUarea), 2),
            "Mediana"    = ~ round(median(AF_prop_OCUarea), 2),
            "max"       = ~ round(max(AF_prop_OCUarea), 2),
            "Média"      = ~ round(mean(AF_prop_OCUarea), 2)),
       "Ocupados por ha útil da AP" =
       list("min"       = ~ round(min(GP_prop_OCUarea), 2),
            "Mediana"    = ~ round(median(GP_prop_OCUarea), 2),
            "max"       = ~ round(max(GP_prop_OCUarea), 2),
            "Média"      = ~ round(mean(GP_prop_OCUarea), 2)),
       
       "VP/ha da AF" =
       list("min"       = ~ round(min(AF_VPdivAREA), 2),
            "Mediana"    = ~ round(median(AF_VPdivAREA), 2),
            "max"       = ~ round(max(AF_VPdivAREA), 2),
            "Média"      = ~ round(mean(AF_VPdivAREA), 2)),
       "VP/ha da AP" =
       list("min"       = ~ round(min(GP_VPdivAREA), 2),
            "Mediana"    = ~ round(median(GP_VPdivAREA), 2),
            "max"       = ~ round(max(GP_VPdivAREA), 2),
            "Média"      = ~ round(mean(GP_VPdivAREA), 2)),
       
       "Prop. das rendas de programas/políticas na AF" =
       list("min"       = ~ round(min(AF_prop3_REC_PROG), 2),
            "Mediana"    = ~ round(median(AF_prop3_REC_PROG), 2),
            "max"       = ~ round(max(AF_prop3_REC_PROG), 2),
            "Média"      = ~ round(mean(AF_prop3_REC_PROG), 2)),
       "Rendimentos totais da AF" =
       list("min"       = ~ round(min(AF_Receita), 2),
            "Mediana"    = ~ round(median(AF_Receita), 2),
            "max"       = ~ round(max(AF_Receita), 2),
            "Média"      = ~ round(mean(AF_Receita), 2)),
       "Rendimentos totais da AP" =
       list("min"       = ~ round(min(GP_Receita), 2),
            "Mediana"    = ~ round(median(GP_Receita), 2),
            "max"       = ~ round(max(GP_Receita), 2),
            "Média"      = ~ round(mean(GP_Receita), 2))
  )
