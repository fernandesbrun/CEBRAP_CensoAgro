...
```{r mapaPLOT RENDAS - Rendas da produção3 PLOT, echo=FALSE, message=FALSE, warning=FALSE, out.width='100%'}
...
* Os valores de participação das outras receitas dos estabelecimentos na composição da renda são extremamente baixos para todas as regiões e tipologias;<br/>
  + Algumas poucas microrregiões possuem valores mais elevados que a média, podendo indicar localidades bastante específicas que exploram outras atividades possíveis para obtenção de renda nos estabelecimentos.<br/>
<br/>
<br/>
...
REC3_PROG <- 
  ...
  labs(x = "", y = "", title = "Receitas de programas e políticas", subtitle = "Participação por tipologia de receiras de programas e políticas no estabelecimento") +
  scale_color_brewer(palette = "Dark2", direction=-1, guide = "none") +
  theme_light() +
  theme(legend.position = 'none',
        plot.title = element_text(hjust = 0.5),
