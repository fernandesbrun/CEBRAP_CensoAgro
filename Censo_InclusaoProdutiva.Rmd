...
IP_microrregioes_sumario2 <- IP_microrregioes_final %>%
  ...
  summarise(REN_DIM = length(R_VALOR_T[R_VALOR_T < Rc_06_VALOR_T]),
            ...
            POBREZA_Abaixo_06 = length(REND_OCU_06_T[REND_OCU_06_T < 120]),
            pctPOBREZA_Abaixo_06 = length(REND_OCU_06_T[REND_OCU_06_T < 120]) / length(REND_OCU_06_T),
            POBREZA_Sairam = length(MOBILI_REND_OCU[MOBILI_REND_OCU == "Saiu da pobreza"]),
            pctPOBREZA_Sairam = length(MOBILI_REND_OCU[MOBILI_REND_OCU == "Saiu da pobreza"]) / length(MOBILI_REND_OCU),
            POBREZA_Entraram = length(MOBILI_REND_OCU[MOBILI_REND_OCU == "Entrou na pobreza"]),
            pctPOBREZA_Entraram = length(MOBILI_REND_OCU[MOBILI_REND_OCU == "Entrou na pobreza"]) / length(MOBILI_REND_OCU),
            POBREZA_Abaixo_17 = length(REND_OCU_T[REND_OCU_T < 170]),
            pctPOBREZA_Abaixo_17 = length(REND_OCU_T[REND_OCU_T < 170]) / length(REND_OCU_T)
...
```
<br>
Em número de microrregiões, a região que mais perdeu valores de 2006 para 2017 foi a Nordeste. Apesar do Sul apresentar porcentagem na região para a variável de número de estabelecimentos e número de pessoas ocupadas superior a do Nordeste, mesmo com a redução proporcional maior nesses dois valores, na região não houve redução no rendimento por pessoal ocupado e por estabelecimento em nenhuma microrregião.

O Centro-Oeste também se destaca como região que não perdeu nenhum tipo de valor de rendimento (total, por pessoal ocupado ou por estabelecimento) em microrregiões. Entretanto, a área total dos estabelecimentos, de 2006 para 2017, reduziu em pelo menos 25% das microrregiões de cada região.
<br>
...
IP_microrregioes_sumario_AF <- IP_microrregioes_final %>%
  ...
  summarise(REN_DIM = length(R_VALOR_AF[R_VALOR_AF < Rc_06_VALOR_AF]),
            ...
            POBREZA_Abaixo_06 = length(REND_OCU_06_AF[REND_OCU_06_AF < 120]),
            pctPOBREZA_Abaixo_06 = length(REND_OCU_06_AF[REND_OCU_06_AF < 120]) / length(REND_OCU_06_AF),
            POBREZA_Sairam = length(MOBILI_REND_OCU_AF[MOBILI_REND_OCU_AF == "Saiu da pobreza"]),
            pctPOBREZA_Sairam = length(MOBILI_REND_OCU_AF[MOBILI_REND_OCU_AF == "Saiu da pobreza"]) / length(MOBILI_REND_OCU_AF),
            POBREZA_Entraram = length(MOBILI_REND_OCU_AF[MOBILI_REND_OCU_AF == "Entrou na pobreza"]),
            pctPOBREZA_Entraram = length(MOBILI_REND_OCU_AF[MOBILI_REND_OCU_AF == "Entrou na pobreza"]) / length(MOBILI_REND_OCU_AF),
            POBREZA_Abaixo_17 = length(REND_OCU_AF[REND_OCU_AF < 170]),
            pctPOBREZA_Abaixo_17 = length(REND_OCU_AF[REND_OCU_AF < 170]) / length(REND_OCU_AF)
            ) %>%
...
IP_microrregioes_sumario_AF <- IP_microrregioes_sumario_AF %>%
  filter(Resumo != "POBREZA_Abaixo_06") %>% 
  filter(Resumo != "POBREZA_Sairam") %>% 
  filter(Resumo != "POBREZA_Entraram") %>% 
  filter(Resumo != "POBREZA_Abaixo_17")
...
IP_microrregioes_sumario_AF[13,1] <- "Microrregiões abaixo da linha da pobreza em 2006"
IP_microrregioes_sumario_AF[14,1] <- "Microrregiões que saíram da pobreza"
IP_microrregioes_sumario_AF[15,1] <- "Microrregiões que entraram na pobreza"
IP_microrregioes_sumario_AF[16,1] <- "Microrregiões abaixo da linha da pobreza em 2017"
...
IP_microrregioes_sumario_NAF <- IP_microrregioes_final %>%
  ...
  summarise(REN_DIM = length(R_VALOR_NAF[R_VALOR_NAF < Rc_06_VALOR_NAF]),
            ...
            POBREZA_Abaixo_06 = length(REND_OCU_06_NAF[REND_OCU_06_NAF < 120]),
            pctPOBREZA_Abaixo_06 = length(REND_OCU_06_NAF[REND_OCU_06_NAF < 120]) / length(REND_OCU_06_NAF),
            POBREZA_Sairam = length(MOBILI_REND_OCU_NAF[MOBILI_REND_OCU_NAF == "Saiu da pobreza"]),
            pctPOBREZA_Sairam = length(MOBILI_REND_OCU_NAF[MOBILI_REND_OCU_NAF == "Saiu da pobreza"]) / length(MOBILI_REND_OCU_NAF),
            POBREZA_Entraram = length(MOBILI_REND_OCU_NAF[MOBILI_REND_OCU_NAF == "Entrou na pobreza"]),
            pctPOBREZA_Entraram = length(MOBILI_REND_OCU_NAF[MOBILI_REND_OCU_NAF == "Entrou na pobreza"]) / length(MOBILI_REND_OCU_NAF),
            POBREZA_Abaixo_17 = length(REND_OCU_NAF[REND_OCU_NAF < 170]),
            pctPOBREZA_Abaixo_17 = length(REND_OCU_NAF[REND_OCU_NAF < 170]) / length(REND_OCU_NAF)
            ) %>%
...
IP_microrregioes_sumario_NAF <- IP_microrregioes_sumario_NAF %>%
  filter(Resumo != "POBREZA_Abaixo_06") %>% 
  filter(Resumo != "POBREZA_Sairam") %>% 
  filter(Resumo != "POBREZA_Entraram") %>% 
  filter(Resumo != "POBREZA_Abaixo_17")
...
IP_microrregioes_sumario_NAF[13,1] <- "Microrregiões abaixo da linha da pobreza em 2006"
IP_microrregioes_sumario_NAF[14,1] <- "Microrregiões que saíram da pobreza"
IP_microrregioes_sumario_NAF[15,1] <- "Microrregiões que entraram na pobreza"
IP_microrregioes_sumario_NAF[16,1] <- "Microrregiões abaixo da linha da pobreza em 2017"
