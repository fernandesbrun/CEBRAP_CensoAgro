...
A média brasileira por municípios, considerando o valor da produção de todos os estabelecimentos agropecuários no ano de referência, é de `r paste("R$",round(media_brasilMUN[1,]$VBP_BRA_mean_T, 1),"(mil reais)")`.

A mediana brasileira por municípios, considerando o valor da produção de todos os estabelecimentos agropecuários no ano de referência, é de `r paste("R$",round(media_brasilMUN[1,]$VBP_BRA_median_T, 1),"(mil reais)")`.
...
A média brasileira por microrregiões, considerando o valor da produção de todos os estabelecimentos agropecuários no ano de referência, é de `r paste("R$",round(media_brasilMIC[1,]$VBP_BRA_mean_T, 1),"(mil reais)")`.

A mediana brasileira por municípios, considerando o valor da produção de todos os estabelecimentos agropecuários no ano de referência, é de `r paste("R$",round(media_brasilMIC[1,]$VBP_BRA_median_T, 1),"(mil reais)")`.
